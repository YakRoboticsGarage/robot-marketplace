...
**Status:** v1.0–v1.4 built. **v1.4.1 complete** (39 MCP tools, 100 test robots on Base Sepolia, 9 category MCP servers, EAS attestation, geographic filtering, busy state, 8 delivery schemas, 9 RFP presets). Repo restructured. Demo at yakrobot.bid/demo.
