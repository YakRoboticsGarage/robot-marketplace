...
**Status:** Active. v1.4 shipped with 36 MCP tools, on-chain ERC-8004 registration, 100-finding code review resolved. Next: v1.5 (settlement abstraction) gated on v1.4.
