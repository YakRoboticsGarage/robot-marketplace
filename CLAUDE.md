...
**v1.0 status:** Built. 264 tests, 35 MCP tools, ~16,270 LOC. 166 commits.
**v1.1 status:** In progress. Gasless USDC payment (ERC-2612 permit relay), Stripe Checkout, robot discovery, IPFS delivery, 4-level deliverable QA.
